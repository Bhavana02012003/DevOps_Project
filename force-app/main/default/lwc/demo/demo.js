...
export default class Demo extends LightningElement {
    ...
    connectedCallback() {
        console.log('Component Loading Bro pleadddsse checkigfdgng the voilations...'); // ❌ `no-console`: `console.log()` is not allowed
    ...
    testFunction() { // ❌ `no-unused-vars`: Function is defined but never used
        ...
        try {
            ...
            console.error("Exceptionssssfddg caught: " + e.message);
        }
    }
}
